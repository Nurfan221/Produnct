...
<input type="text" name="sc" placehorder="Cari Produk" value="<?php echo $_GET['sc'] ?>" >
...
<div class="section">
    <div class="container">
        ...
        <?php 
        if($_GET['sc'] != ''){
            $where = "AND produk_name LIKE '%".$_GET['sc']."%'";
        }

        $produk = mysqli_query($conn, "SELECT * FROM produk WHERE produk_status !=0 $where ORDER BY produk_id DESC");
